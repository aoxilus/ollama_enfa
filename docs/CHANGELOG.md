...
Product documentation index: [INDEX.md](INDEX.md).
...
- Docs: product docs consolidated in `docs/` with normalized README layout and index.
...
- Better contributor alignment: one product-facing docs structure under `docs/`.
